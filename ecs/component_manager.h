...
public:
   ...
   * @tparam C Component
   */
  template <typename C> void register_component();

  /**
   * Unregisters a component
   * @tparam C Component
   */
  template <typename C> void unregister_component();
   ...
   */
  template <typename C> C &add_component_entity(Entity entity);
   ...
   */
  template <typename C> void remove_component_entity(Entity entity);
  ...
  template <typename C> void map_component(C (*func)(C val));
  /**
   *
   * @tparam C A component
   * @return The component type associated with that component
   */
  template <typename C> ComponentType get_component_type();
   ...
   */
  template <typename C> bool is_component_registered();

private:
  /**
   * @tparam C component
   * @return The packed array responsible for that type of component
   */
  template <typename C> PackedArray<C> *get_component_array();
